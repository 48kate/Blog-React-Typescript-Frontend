                ...
                <div className='row g-0 mt-5'>
                    ...
                    <div className='col-4 col-md-4 container d-flex justify-content-center align-items-center'>
                        <div className='ml-2'>
                            ...
                            <Link className='btn main-color btn-lg text-white' to={"/auth/register"}>Sign in</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className='container'>
                    <div className='m-2'>
                        ...
                        <div className='mt-2'>
                            ...
                            <Link className='btn main-color btn-lg text-white' to={"/registration"}>Sign in</Link>
                        </div>
                    </div>
                    <div className='m-2'>
                        <div className='col-image-right'></div>
